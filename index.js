...
/**
 * Функція extendAndFreezeObject приймає два об'єкти, розширює перший властивостями другого і "заморожує" отриманий об'єкт, 
 * //запобігаючи подальшим змінам.
...
console.log(checkOwnership({ a: 2, b: 2, c: 3 }, { a: 1, b: 2, c: 4 }, "a")); // true
...
function getObjectValuesSum(obj) {
  ...
  const valuesArray = Object.values(obj);
    ...
    const sum = valuesArray.reduce((accum, value) => accum + value, 0)
